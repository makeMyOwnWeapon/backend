create table if not exists main_lectures
(
...
create table if not exists gpt_usage_histories
(
    id         int auto_increment
        primary key,
    created_at datetime(6) default CURRENT_TIMESTAMP(6) not null,
    member_id  int                                      null,
    constraint FK_be68fba03fe5b460be8cfdac367
...
(
    ...
    total_learning_time int                                      not null,
...
create table if not exists lecture_image_urls
(
    id             int auto_increment
        primary key,
    created_at     datetime(6) default CURRENT_TIMESTAMP(6) not null,
    url            varchar(2048)                            not null,
    sub_lecture_id int                                      null,
    constraint REL_9b400c5bfb962fad6c490db246
        unique (sub_lecture_id),
    constraint FK_9b400c5bfb962fad6c490db2464
        foreign key (sub_lecture_id) references sub_lectures (id)
);
...
(
    ...
    quiz_id         int                                      null,
    choice_id       int                                      null,
    constraint REL_0df3afb147443fd79bcd5e3653
        unique (choice_id),
    constraint FK_0df3afb147443fd79bcd5e36534
